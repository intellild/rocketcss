...
fn every_css_ast_node_implements_to_css() {
    assert_types! {
        ...
        Navigation, DefaultAtRule, StyleSheet<'static>, CharsetRule<'static>, MediaRule<'static>,
        MediaList<'static>, MediaQuery<'static>, LengthValue, EnvironmentVariable<'static>, Url<'static>,
