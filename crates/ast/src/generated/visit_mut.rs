...
pub trait VisitorMut<'a, 'ghost> {
    ...
    #[inline]
    fn visit_lab_color(&mut self, node: &mut LABColor, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_system_color(
        &mut self,
        node: &mut SystemColor,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_ratio(&mut self, node: &mut Ratio, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_angle(&mut self, node: &mut Angle, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_time(&mut self, node: &mut Time, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_operator(&mut self, node: &mut Operator, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_media_type(
        &mut self,
        node: &mut MediaType<'a>,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_qualifier(&mut self, node: &mut Qualifier, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    fn visit_property_parser_strategy(
        &mut self,
        node: &mut PropertyParserStrategy,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    fn visit_property_support(
        &mut self,
        node: &mut PropertySupport,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_blend_mode(&mut self, node: &mut BlendMode, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_transition(
    ...
    #[inline]
    fn visit_position(&mut self, node: &mut Position<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_image_set(&mut self, node: &mut ImageSet<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_border_style(
        &mut self,
        node: &mut BorderStyle,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_source(&mut self, node: &mut Source<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_base_palette(
        &mut self,
        node: &mut BasePalette,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_font(&mut self, node: &mut Font<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        FontFamily<'a>: AstNodeStorage<'a>,
    ...
    #[inline]
    fn visit_aspect_ratio(
        &mut self,
        node: &mut AspectRatio,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_overflow(&mut self, node: &mut Overflow, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_flex_flow(&mut self, node: &mut FlexFlow, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_place_self(&mut self, node: &mut PlaceSelf, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_place_items(
        &mut self,
        node: &mut PlaceItems,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
    ...
    #[inline]
    fn visit_column_count(
        &mut self,
        node: &mut ColumnCount,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_grid(&mut self, node: &mut Grid<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        GridTemplateAreas<'a>: AstNodeStorage<'a>,
        TrackSize<'a>: AstNodeStorage<'a>,
        TrackSizing<'a>: AstNodeStorage<'a>,
    ...
    #[inline]
    fn visit_grid_row(&mut self, node: &mut GridRow<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_grid_area(&mut self, node: &mut GridArea<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        GridLine<'a>: AstNodeStorage<'a>,
    {
        VisitMut::visit_mut_children(node, self, cx);
    ...
    #[inline]
    fn visit_mask(&mut self, node: &mut Mask<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        Image<'a>: AstNodeStorage<'a>,
        Position<'a>: AstNodeStorage<'a>,
        BackgroundSize<'a>: AstNodeStorage<'a>,
    ...
    #[inline]
    fn visit_url(&mut self, node: &mut Url<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_variable(&mut self, node: &mut Variable<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_rotate(&mut self, node: &mut Rotate, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_cursor(&mut self, node: &mut Cursor<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_caret(&mut self, node: &mut Caret<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_composes(&mut self, node: &mut Composes<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_color_scheme(
        &mut self,
        node: &mut ColorScheme,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_selector(&mut self, node: &mut Selector<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_nth_type(&mut self, node: &mut NthType, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_direction(&mut self, node: &mut Direction, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_span(&mut self, node: &mut Span, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_unit(&mut self, node: &mut Unit, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_token(&mut self, node: &mut Token<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_specifier(
        &mut self,
        node: &mut Specifier<'a>,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_align_self(&mut self, node: &mut AlignSelf, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_justify_self(
        &mut self,
        node: &mut JustifySelf,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_align_items(
        &mut self,
        node: &mut AlignItems,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
    ...
    #[inline]
    fn visit_gap_value(&mut self, node: &mut GapValue<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        LengthPercentage<'a>: AstNodeStorage<'a>,
    {
        VisitMut::visit_mut_children(node, self, cx);
    ...
    #[inline]
    fn visit_scroller(&mut self, node: &mut Scroller, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_line_style(&mut self, node: &mut LineStyle, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_display(&mut self, node: &mut Display, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_size(&mut self, node: &mut Size<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        LengthPercentage<'a>: AstNodeStorage<'a>,
        Function<'a>: AstNodeStorage<'a>,
    {
    ...
    #[inline]
    fn visit_max_size(&mut self, node: &mut MaxSize<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        LengthPercentage<'a>: AstNodeStorage<'a>,
        Function<'a>: AstNodeStorage<'a>,
    {
    ...
    #[inline]
    fn visit_box_sizing(&mut self, node: &mut BoxSizing, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_z_index(&mut self, node: &mut ZIndex, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_filter(&mut self, node: &mut Filter<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        Length<'a>: AstNodeStorage<'a>,
    ...
    #[inline]
    fn visit_flex_wrap(&mut self, node: &mut FlexWrap, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_box_orient(&mut self, node: &mut BoxOrient, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_box_align(&mut self, node: &mut BoxAlign, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_box_pack(&mut self, node: &mut BoxPack, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_box_lines(&mut self, node: &mut BoxLines, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_flex_pack(&mut self, node: &mut FlexPack, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_font_size(&mut self, node: &mut FontSize<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        LengthPercentage<'a>: AstNodeStorage<'a>,
    {
        VisitMut::visit_mut_children(node, self, cx);
    ...
    #[inline]
    fn visit_font_stretch(
        &mut self,
        node: &mut FontStretch,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_font_style(&mut self, node: &mut FontStyle, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_repeat_count(
        &mut self,
        node: &mut RepeatCount,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_image(&mut self, node: &mut Image<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        Url<'a>: AstNodeStorage<'a>,
    ...
    #[inline]
    fn visit_object_fit(&mut self, node: &mut ObjectFit, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_gradient(&mut self, node: &mut Gradient<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_shape_extent(
        &mut self,
        node: &mut ShapeExtent,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_symbols_type(
        &mut self,
        node: &mut SymbolsType,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_symbol(&mut self, node: &mut Symbol<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        Image<'a>: AstNodeStorage<'a>,
    {
        VisitMut::visit_mut_children(node, self, cx);
    ...
    #[inline]
    fn visit_mask_mode(&mut self, node: &mut MaskMode, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_mask_clip(&mut self, node: &mut MaskClip, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_mask_type(&mut self, node: &mut MaskType, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_clip_path(&mut self, node: &mut ClipPath<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        Url<'a>: AstNodeStorage<'a>,
    ...
    #[inline]
    fn visit_geometry_box(
        &mut self,
        node: &mut GeometryBox,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_svg_paint(&mut self, node: &mut SVGPaint<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
    ...
    #[inline]
    fn visit_fill_rule(&mut self, node: &mut FillRule, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_marker(&mut self, node: &mut Marker<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>)
    where
        Url<'a>: AstNodeStorage<'a>,
    {
        VisitMut::visit_mut_children(node, self, cx);
    ...
    #[inline]
    fn visit_word_break(&mut self, node: &mut WordBreak, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_line_break(&mut self, node: &mut LineBreak, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_hyphens(&mut self, node: &mut Hyphens, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_text_align(&mut self, node: &mut TextAlign, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    ...
    #[inline]
    fn visit_text_justify(
        &mut self,
        node: &mut TextJustify,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    ...
    #[inline]
    fn visit_unicode_bidi(
        &mut self,
        node: &mut UnicodeBidi,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_content(&mut self, node: &mut Content<'a>, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_transform(
    ...
    #[inline]
    fn visit_scale(&mut self, node: &mut Scale, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_resize(&mut self, node: &mut Resize, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_scrollbar_color(
        &mut self,
        node: &mut ScrollbarColor<'a>,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) where
        CssColor<'a>: AstNodeStorage<'a>,
    {
    ...
    #[inline]
    fn visit_pointer_events(
        &mut self,
        node: &mut PointerEvents,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_float(&mut self, node: &mut Float, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_clear(&mut self, node: &mut Clear, cx: &mut VisitMutContext<'_, 'a, 'ghost>) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_touch_action(
        &mut self,
        node: &mut TouchAction,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
    #[inline]
    fn visit_scroll_behavior(
        &mut self,
        node: &mut ScrollBehavior,
        cx: &mut VisitMutContext<'_, 'a, 'ghost>,
    ) {
        VisitMut::visit_mut_children(node, self, cx);
    }
