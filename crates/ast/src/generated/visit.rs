...
pub trait Visitor<'a> {
    ...
    #[inline]
    fn visit_known_color(&mut self, node: &KnownColor) {
        Visit::visit_children(node, self);
    }
    #[inline]
    ...
    #[inline]
    fn visit_animation_component(&mut self, node: &AnimationComponent<'a>) {
        Visit::visit_children(node, self);
    }
    #[inline]
    fn visit_animation_keyword_class(&mut self, node: &AnimationKeywordClass) {
        Visit::visit_children(node, self);
    }
    #[inline]
    ...
    #[inline]
    fn visit_column_rule(&mut self, node: &ColumnRule<'a>) {
        Visit::visit_children(node, self);
    }
    #[inline]
    fn visit_column_width(&mut self, node: &ColumnWidth<'a>) {
        Visit::visit_children(node, self);
    }
    #[inline]
    fn visit_column_count(&mut self, node: &ColumnCount) {
        Visit::visit_children(node, self);
    }
    #[inline]
    fn visit_columns(&mut self, node: &Columns<'a>) {
        Visit::visit_children(node, self);
    }
    #[inline]
    ...
    #[inline]
    fn visit_css_wide_or<T>(&mut self, node: &CSSWideOr<T>)
    where
        T: Visit<'a>,
    {
        Visit::visit_children(node, self);
