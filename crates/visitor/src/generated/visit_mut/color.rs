...
use crate::AstType;
use rocketcss_ast::*;
impl<'a> VisitMut<'a> for CssColor<'a> {
    #[inline]
...
impl<'a> VisitMut<'a> for LABColor {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for PredefinedColor {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for FloatColor {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for LightDark<'a> {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
    ...
    fn visit_mut_children<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
        ...
        let node = self;
        VisitMut::visit_mut((&mut node.dark).as_mut(), visitor);
        VisitMut::visit_mut((&mut node.light).as_mut(), visitor);
        visitor.leave_node(AstType::LightDark);
    }
}
impl<'a> VisitMut<'a> for SystemColor {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for UnresolvedColor<'a> {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
