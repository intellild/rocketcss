...
use crate::AstType;
use rs_css_ast::*;
pub fn walk_length<'a, VisitorT>(visitor: &mut VisitorT, node: &mut Length<'a>)
where
...
pub fn walk_length_unit<'a, VisitorT>(visitor: &mut VisitorT, node: &mut LengthUnit)
where
    VisitorT: ?Sized + VisitMut<'a>,
{
...
pub fn walk_calc<'a, V, VisitorT>(visitor: &mut VisitorT, node: &mut Calc<'a, V>)
where
    VisitorT: ?Sized + VisitMut<'a>,
    V: VisitMutNode<'a, VisitorT>,
{
    ...
    match node {
        ...
        Calc::Number(field_0) => {}
        Calc::Sum(field_0) => {
            visitor.visit_calc((&mut (field_0).0).as_mut());
            visitor.visit_calc((&mut (field_0).1).as_mut());
        }
        Calc::Product(field_0) => {
            visitor.visit_calc((&mut (field_0).1).as_mut());
        }
        Calc::Function(field_0) => {
            visitor.visit_math_function((field_0).as_mut());
        }
    }
    visitor.leave_node(AstType::Calc);
}
pub fn walk_math_function<'a, V, VisitorT>(visitor: &mut VisitorT, node: &mut MathFunction<'a, V>)
where
    VisitorT: ?Sized + VisitMut<'a>,
    V: VisitMutNode<'a, VisitorT>,
{
    ...
    match node {
        ...
        MathFunction::Clamp(field_0) => {
            visitor.visit_calc((&mut (field_0).0).as_mut());
            visitor.visit_calc((&mut (field_0).1).as_mut());
            visitor.visit_calc((&mut (field_0).2).as_mut());
        }
        MathFunction::Round(field_0) => {
            visitor.visit_rounding_strategy(&mut (field_0).0);
            visitor.visit_calc((&mut (field_0).1).as_mut());
            visitor.visit_calc((&mut (field_0).2).as_mut());
        }
...
pub fn walk_rounding_strategy<'a, VisitorT>(visitor: &mut VisitorT, node: &mut RoundingStrategy)
where
    VisitorT: ?Sized + VisitMut<'a>,
{
...
pub fn walk_resolution<'a, VisitorT>(visitor: &mut VisitorT, node: &mut Resolution)
where
    VisitorT: ?Sized + VisitMut<'a>,
{
...
pub fn walk_ratio<'a, VisitorT>(visitor: &mut VisitorT, node: &mut Ratio)
where
    VisitorT: ?Sized + VisitMut<'a>,
{
...
pub fn walk_angle<'a, VisitorT>(visitor: &mut VisitorT, node: &mut Angle)
where
    VisitorT: ?Sized + VisitMut<'a>,
{
...
pub fn walk_time<'a, VisitorT>(visitor: &mut VisitorT, node: &mut Time)
where
    VisitorT: ?Sized + VisitMut<'a>,
{
