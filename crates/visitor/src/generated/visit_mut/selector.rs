...
use crate::AstType;
use rocketcss_ast::*;
impl<'a> VisitMut<'a> for SelectorComponent<'a> {
    #[inline]
    ...
    fn visit_mut_children<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
        ...
        match node {
            ...
            SelectorComponent::AttributeInNoNamespace {
                ...
                VisitMut::visit_mut(case_sensitivity, visitor);
            }
            ...
            SelectorComponent::NthOf { data, selectors } => {
                VisitMut::visit_mut(data, visitor);
...
impl<'a> VisitMut<'a> for Combinator {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for AttrSelector<'a> {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
    ...
    fn visit_mut_children<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
        ...
        VisitMut::visit_mut(&mut node.operation, visitor);
        visitor.leave_node(AstType::AttrSelector);
    }
}
impl<'a> VisitMut<'a> for NamespaceConstraint<'a> {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for AttrOperation<'a> {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for ParsedCaseSensitivity {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for AttrSelectorOperator {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for NthSelectorData {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
    ...
    fn visit_mut_children<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
        ...
        let node = self;
        VisitMut::visit_mut(&mut node.kind, visitor);
        visitor.leave_node(AstType::NthSelectorData);
    }
}
impl<'a> VisitMut<'a> for Direction {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for PseudoClass<'a> {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
    ...
    fn visit_mut_children<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
        ...
        match node {
            ...
            PseudoClass::Dir { direction } => {
                VisitMut::visit_mut(direction, visitor);
            }
            PseudoClass::Hover => {}
            PseudoClass::Active => {}
            PseudoClass::Focus => {}
...
impl<'a> VisitMut<'a> for WebKitScrollbarPseudoClass {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for PseudoElement<'a> {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
    ...
    fn visit_mut_children<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
        ...
        match node {
            ...
            PseudoElement::ViewTransitionGroup { part } => {
                VisitMut::visit_mut((part).as_mut(), visitor);
            }
            ...
            PseudoElement::CustomFunction { name, arguments } => {
                ...
                for value_6 in (arguments).iter_mut() {
                    VisitMut::visit_mut(value_6, visitor);
                }
            }
        }
...
impl<'a> VisitMut<'a> for WebKitScrollbarPseudoElement {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
...
impl<'a> VisitMut<'a> for ViewTransitionPartName<'a> {
    #[inline]
    fn visit_mut<VisitorT: ?Sized + VisitorMut<'a>>(&mut self, visitor: &mut VisitorT) {
