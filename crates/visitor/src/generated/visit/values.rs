...
use crate::AstType;
use rocketcss_ast::*;
pub fn walk_image<'a, VisitorT>(visitor: &mut VisitorT, node: &Image<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        ...
        Image::Gradient(field_0) => {
            visitor.visit_gradient((field_0).as_ref());
        }
        Image::ImageSet(field_0) => {
            visitor.visit_image_set((field_0).as_ref());
        }
    }
    visitor.leave_node(AstType::Image);
}
pub fn walk_gradient<'a, VisitorT>(visitor: &mut VisitorT, node: &Gradient<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        Gradient::Linear {
            ...
            visitor.visit_line_direction((direction).as_ref());
        ...
        Gradient::Radial {
            ...
            visitor.visit_position((position).as_ref());
            visitor.visit_ending_shape((shape).as_ref());
            visitor.visit_vendor_prefix(vendor_prefix);
        }
        ...
        Gradient::Conic {
            ...
            visitor.visit_angle((angle).as_ref());
        ...
        Gradient::WebKitGradient(field_0) => {
            visitor.visit_web_kit_gradient((field_0).as_ref());
        }
    }
    visitor.leave_node(AstType::Gradient);
}
pub fn walk_web_kit_gradient<'a, VisitorT>(visitor: &mut VisitorT, node: &WebKitGradient<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        WebKitGradient::Linear { from, to, stops } => {
            visitor.visit_web_kit_gradient_point((from).as_ref());
            visitor.visit_web_kit_gradient_point((to).as_ref());
...
pub fn walk_line_direction<'a, VisitorT>(visitor: &mut VisitorT, node: &LineDirection<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_gradient_item<'a, D, VisitorT>(visitor: &mut VisitorT, node: &GradientItem<'a, D>)
where
    VisitorT: ?Sized + Visit<'a>,
    D: VisitNode<'a, VisitorT>,
{
    ...
    match node {
        GradientItem::ColorStop { color, position } => {
            visitor.visit_css_color((color).as_ref());
            if let Some(value_1) = (position).as_ref() {
                visitor.visit_dimension_percentage((value_1).as_ref());
            }
        }
        GradientItem::Hint(field_0) => {
            visitor.visit_dimension_percentage((field_0).as_ref());
        }
    }
    ...
    S: VisitNode<'a, VisitorT>,
{
    ...
    match node {
        ...
        PositionComponent::Side { offset, side } => {
            ...
            VisitNode::visit_node(side, visitor);
        }
    }
    visitor.leave_node(AstType::PositionComponent);
}
pub fn walk_ending_shape<'a, VisitorT>(visitor: &mut VisitorT, node: &EndingShape<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        EndingShape::Ellipse(field_0) => {
            visitor.visit_ellipse((field_0).as_ref());
        }
        EndingShape::Circle(field_0) => {
            visitor.visit_circle((field_0).as_ref());
        }
    }
    visitor.leave_node(AstType::EndingShape);
}
pub fn walk_ellipse<'a, VisitorT>(visitor: &mut VisitorT, node: &Ellipse<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_shape_extent<'a, VisitorT>(visitor: &mut VisitorT, node: &ShapeExtent)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_circle<'a, VisitorT>(visitor: &mut VisitorT, node: &Circle<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    S: VisitNode<'a, VisitorT>,
{
    ...
    match node {
        ...
        WebKitGradientPointComponent::Number(field_0) => {
            visitor.visit_number_or_percentage((field_0).as_ref());
        }
        WebKitGradientPointComponent::Side(field_0) => {
            VisitNode::visit_node(field_0, visitor);
        }
    }
    visitor.leave_node(AstType::WebKitGradientPointComponent);
}
pub fn walk_number_or_percentage<'a, VisitorT>(visitor: &mut VisitorT, node: &NumberOrPercentage)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_background_size<'a, VisitorT>(visitor: &mut VisitorT, node: &BackgroundSize<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        BackgroundSize::Explicit { height, width } => {
            visitor.visit_length_percentage_or_auto((height).as_ref());
            visitor.visit_length_percentage_or_auto((width).as_ref());
        }
...
pub fn walk_background_attachment<'a, VisitorT>(visitor: &mut VisitorT, node: &BackgroundAttachment)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_background_clip<'a, VisitorT>(visitor: &mut VisitorT, node: &BackgroundClip)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_background_origin<'a, VisitorT>(visitor: &mut VisitorT, node: &BackgroundOrigin)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_display<'a, VisitorT>(visitor: &mut VisitorT, node: &Display<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        ...
        Display::Pair {
            ...
            visitor.visit_display_inside((inside).as_ref());
            visitor.visit_display_outside(outside);
        }
    }
    visitor.leave_node(AstType::Display);
}
pub fn walk_display_keyword<'a, VisitorT>(visitor: &mut VisitorT, node: &DisplayKeyword)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_display_inside<'a, VisitorT>(visitor: &mut VisitorT, node: &DisplayInside)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_display_outside<'a, VisitorT>(visitor: &mut VisitorT, node: &DisplayOutside)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_visibility<'a, VisitorT>(visitor: &mut VisitorT, node: &Visibility)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_size<'a, VisitorT>(visitor: &mut VisitorT, node: &Size<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_max_size<'a, VisitorT>(visitor: &mut VisitorT, node: &MaxSize<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_box_sizing<'a, VisitorT>(visitor: &mut VisitorT, node: &BoxSizing)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_overflow_keyword<'a, VisitorT>(visitor: &mut VisitorT, node: &OverflowKeyword)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_overflow<'a, VisitorT>(visitor: &mut VisitorT, node: &TextOverflow)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_position_property<'a, VisitorT>(visitor: &mut VisitorT, node: &PositionProperty)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_size_2_d<'a, T, VisitorT>(visitor: &mut VisitorT, node: &Size2D<'a, T>)
where
    VisitorT: ?Sized + Visit<'a>,
    T: VisitNode<'a, VisitorT>,
{
    visitor.enter_node(AstType::Size2D);
    VisitNode::visit_node((&node.0).as_ref(), visitor);
    VisitNode::visit_node((&node.1).as_ref(), visitor);
    visitor.leave_node(AstType::Size2D);
}
pub fn walk_rect<'a, T, VisitorT>(visitor: &mut VisitorT, node: &Rect<'a, T>)
where
    VisitorT: ?Sized + Visit<'a>,
    T: VisitNode<'a, VisitorT>,
{
    ...
    VisitNode::visit_node((&node.0).as_ref(), visitor);
    VisitNode::visit_node((&node.1).as_ref(), visitor);
    VisitNode::visit_node((&node.2).as_ref(), visitor);
    VisitNode::visit_node((&node.3).as_ref(), visitor);
    visitor.leave_node(AstType::Rect);
}
pub fn walk_line_style<'a, VisitorT>(visitor: &mut VisitorT, node: &LineStyle)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_border_side_width<'a, VisitorT>(visitor: &mut VisitorT, node: &BorderSideWidth<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_length_or_number<'a, VisitorT>(visitor: &mut VisitorT, node: &LengthOrNumber<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_outline_style<'a, VisitorT>(visitor: &mut VisitorT, node: &OutlineStyle)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_flex_direction<'a, VisitorT>(visitor: &mut VisitorT, node: &FlexDirection)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_flex_wrap<'a, VisitorT>(visitor: &mut VisitorT, node: &FlexWrap)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_align_content<'a, VisitorT>(visitor: &mut VisitorT, node: &AlignContent)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_baseline_position<'a, VisitorT>(visitor: &mut VisitorT, node: &BaselinePosition)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_content_distribution<'a, VisitorT>(visitor: &mut VisitorT, node: &ContentDistribution)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_overflow_position<'a, VisitorT>(visitor: &mut VisitorT, node: &OverflowPosition)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_content_position<'a, VisitorT>(visitor: &mut VisitorT, node: &ContentPosition)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_justify_content<'a, VisitorT>(visitor: &mut VisitorT, node: &JustifyContent)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_align_self<'a, VisitorT>(visitor: &mut VisitorT, node: &AlignSelf)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_self_position<'a, VisitorT>(visitor: &mut VisitorT, node: &SelfPosition)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_justify_self<'a, VisitorT>(visitor: &mut VisitorT, node: &JustifySelf)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_align_items<'a, VisitorT>(visitor: &mut VisitorT, node: &AlignItems)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_justify_items<'a, VisitorT>(visitor: &mut VisitorT, node: &JustifyItems)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_legacy_justify<'a, VisitorT>(visitor: &mut VisitorT, node: &LegacyJustify)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_gap_value<'a, VisitorT>(visitor: &mut VisitorT, node: &GapValue<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_box_orient<'a, VisitorT>(visitor: &mut VisitorT, node: &BoxOrient)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_box_direction<'a, VisitorT>(visitor: &mut VisitorT, node: &BoxDirection)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_box_align<'a, VisitorT>(visitor: &mut VisitorT, node: &BoxAlign)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_box_pack<'a, VisitorT>(visitor: &mut VisitorT, node: &BoxPack)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_box_lines<'a, VisitorT>(visitor: &mut VisitorT, node: &BoxLines)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_flex_pack<'a, VisitorT>(visitor: &mut VisitorT, node: &FlexPack)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_flex_item_align<'a, VisitorT>(visitor: &mut VisitorT, node: &FlexItemAlign)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_flex_line_pack<'a, VisitorT>(visitor: &mut VisitorT, node: &FlexLinePack)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_track_sizing<'a, VisitorT>(visitor: &mut VisitorT, node: &TrackSizing<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_track_list_item<'a, VisitorT>(visitor: &mut VisitorT, node: &TrackListItem<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        TrackListItem::TrackSize(field_0) => {
            visitor.visit_track_size((field_0).as_ref());
        }
        TrackListItem::TrackRepeat(field_0) => {
            visitor.visit_track_repeat((field_0).as_ref());
        }
    }
    visitor.leave_node(AstType::TrackListItem);
}
pub fn walk_track_size<'a, VisitorT>(visitor: &mut VisitorT, node: &TrackSize<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        TrackSize::TrackBreadth(field_0) => {
            visitor.visit_track_breadth((field_0).as_ref());
        }
        TrackSize::MinMax { max, min } => {
            visitor.visit_track_breadth((max).as_ref());
            visitor.visit_track_breadth((min).as_ref());
        }
...
pub fn walk_track_breadth<'a, VisitorT>(visitor: &mut VisitorT, node: &TrackBreadth<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_repeat_count<'a, VisitorT>(visitor: &mut VisitorT, node: &RepeatCount)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_auto_flow_direction<'a, VisitorT>(visitor: &mut VisitorT, node: &AutoFlowDirection)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_grid_template_areas<'a, VisitorT>(visitor: &mut VisitorT, node: &GridTemplateAreas<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_grid_line<'a, VisitorT>(visitor: &mut VisitorT, node: &GridLine<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_font_weight<'a, VisitorT>(visitor: &mut VisitorT, node: &FontWeight<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        FontWeight::Absolute(field_0) => {
            visitor.visit_absolute_font_weight((field_0).as_ref());
        }
        FontWeight::Bolder => {}
        FontWeight::Lighter => {}
    }
...
pub fn walk_absolute_font_weight<'a, VisitorT>(visitor: &mut VisitorT, node: &AbsoluteFontWeight)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_font_size<'a, VisitorT>(visitor: &mut VisitorT, node: &FontSize<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_absolute_font_size<'a, VisitorT>(visitor: &mut VisitorT, node: &AbsoluteFontSize)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_relative_font_size<'a, VisitorT>(visitor: &mut VisitorT, node: &RelativeFontSize)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_font_stretch<'a, VisitorT>(visitor: &mut VisitorT, node: &FontStretch)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_font_stretch_keyword<'a, VisitorT>(visitor: &mut VisitorT, node: &FontStretchKeyword)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_font_family<'a, VisitorT>(visitor: &mut VisitorT, node: &FontFamily<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_generic_font_family<'a, VisitorT>(visitor: &mut VisitorT, node: &GenericFontFamily)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_font_style<'a, VisitorT>(visitor: &mut VisitorT, node: &FontStyle<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_font_variant_caps<'a, VisitorT>(visitor: &mut VisitorT, node: &FontVariantCaps)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_line_height<'a, VisitorT>(visitor: &mut VisitorT, node: &LineHeight<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_vertical_align<'a, VisitorT>(visitor: &mut VisitorT, node: &VerticalAlign<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_easing_function<'a, VisitorT>(visitor: &mut VisitorT, node: &EasingFunction)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_step_position<'a, VisitorT>(visitor: &mut VisitorT, node: &StepPosition)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_animation_direction<'a, VisitorT>(visitor: &mut VisitorT, node: &AnimationDirection)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_animation_play_state<'a, VisitorT>(visitor: &mut VisitorT, node: &AnimationPlayState)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_animation_fill_mode<'a, VisitorT>(visitor: &mut VisitorT, node: &AnimationFillMode)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_animation_composition<'a, VisitorT>(visitor: &mut VisitorT, node: &AnimationComposition)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_animation_timeline<'a, VisitorT>(visitor: &mut VisitorT, node: &AnimationTimeline<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        ...
        AnimationTimeline::View(field_0) => {
            visitor.visit_view_timeline((field_0).as_ref());
        }
    }
    visitor.leave_node(AstType::AnimationTimeline);
}
pub fn walk_scroll_axis<'a, VisitorT>(visitor: &mut VisitorT, node: &ScrollAxis)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_scroller<'a, VisitorT>(visitor: &mut VisitorT, node: &Scroller)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_timeline_range_name<'a, VisitorT>(visitor: &mut VisitorT, node: &TimelineRangeName)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_transform<'a, VisitorT>(visitor: &mut VisitorT, node: &Transform<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        ...
        Transform::Translate3d(field_0) => {
            visitor.visit_length_percentage((&(field_0).0).as_ref());
            visitor.visit_length_percentage((&(field_0).1).as_ref());
            visitor.visit_length((&(field_0).2).as_ref());
        }
        Transform::Scale(field_0) => {
            visitor.visit_number_or_percentage((&(field_0).0).as_ref());
            visitor.visit_number_or_percentage((&(field_0).1).as_ref());
        }
        ...
        Transform::Scale3d(field_0) => {
            visitor.visit_number_or_percentage((&(field_0).0).as_ref());
            visitor.visit_number_or_percentage((&(field_0).1).as_ref());
            visitor.visit_number_or_percentage((&(field_0).2).as_ref());
        }
        ...
        Transform::Rotate3d(field_0) => {
            visitor.visit_angle((&(field_0).3).as_ref());
        }
        Transform::Skew(field_0) => {
            visitor.visit_angle((&(field_0).0).as_ref());
            visitor.visit_angle((&(field_0).1).as_ref());
        }
        ...
        Transform::Matrix(field_0) => {
            visitor.visit_matrix_for_float((field_0).as_ref());
        }
        Transform::Matrix3d(field_0) => {
            visitor.visit_matrix_3_d_for_float((field_0).as_ref());
        }
    }
    visitor.leave_node(AstType::Transform);
}
pub fn walk_transform_style<'a, VisitorT>(visitor: &mut VisitorT, node: &TransformStyle)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_transform_box<'a, VisitorT>(visitor: &mut VisitorT, node: &TransformBox)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_backface_visibility<'a, VisitorT>(visitor: &mut VisitorT, node: &BackfaceVisibility)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_perspective<'a, VisitorT>(visitor: &mut VisitorT, node: &Perspective<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_translate<'a, VisitorT>(visitor: &mut VisitorT, node: &Translate<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        ...
        Translate::Xyz { x, y, z } => {
            visitor.visit_length_percentage((x).as_ref());
            visitor.visit_length_percentage((y).as_ref());
            visitor.visit_length((z).as_ref());
        }
    }
    visitor.leave_node(AstType::Translate);
}
pub fn walk_scale<'a, VisitorT>(visitor: &mut VisitorT, node: &Scale<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        Scale::None => {}
        Scale::Xyz { x, y, z } => {
            visitor.visit_number_or_percentage((x).as_ref());
            visitor.visit_number_or_percentage((y).as_ref());
            visitor.visit_number_or_percentage((z).as_ref());
        }
    }
    visitor.leave_node(AstType::Scale);
}
pub fn walk_text_transform_case<'a, VisitorT>(visitor: &mut VisitorT, node: &TextTransformCase)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_white_space<'a, VisitorT>(visitor: &mut VisitorT, node: &WhiteSpace)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_word_break<'a, VisitorT>(visitor: &mut VisitorT, node: &WordBreak)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_line_break<'a, VisitorT>(visitor: &mut VisitorT, node: &LineBreak)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_hyphens<'a, VisitorT>(visitor: &mut VisitorT, node: &Hyphens)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_overflow_wrap<'a, VisitorT>(visitor: &mut VisitorT, node: &OverflowWrap)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_align<'a, VisitorT>(visitor: &mut VisitorT, node: &TextAlign)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_align_last<'a, VisitorT>(visitor: &mut VisitorT, node: &TextAlignLast)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_justify<'a, VisitorT>(visitor: &mut VisitorT, node: &TextJustify)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_spacing<'a, VisitorT>(visitor: &mut VisitorT, node: &Spacing<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_decoration_style<'a, VisitorT>(visitor: &mut VisitorT, node: &TextDecorationStyle)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_emphasis_style<'a, VisitorT>(visitor: &mut VisitorT, node: &TextEmphasisStyle<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_emphasis_shape<'a, VisitorT>(visitor: &mut VisitorT, node: &TextEmphasisShape)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_size_adjust<'a, VisitorT>(visitor: &mut VisitorT, node: &TextSizeAdjust)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_direction<'a, VisitorT>(visitor: &mut VisitorT, node: &TextDirection)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_unicode_bidi<'a, VisitorT>(visitor: &mut VisitorT, node: &UnicodeBidi)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_box_decoration_break<'a, VisitorT>(visitor: &mut VisitorT, node: &BoxDecorationBreak)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_resize<'a, VisitorT>(visitor: &mut VisitorT, node: &Resize)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_cursor_keyword<'a, VisitorT>(visitor: &mut VisitorT, node: &CursorKeyword)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_color_or_auto<'a, VisitorT>(visitor: &mut VisitorT, node: &ColorOrAuto<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_caret_shape<'a, VisitorT>(visitor: &mut VisitorT, node: &CaretShape)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_user_select<'a, VisitorT>(visitor: &mut VisitorT, node: &UserSelect)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_appearance<'a, VisitorT>(visitor: &mut VisitorT, node: &Appearance<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_list_style_type<'a, VisitorT>(visitor: &mut VisitorT, node: &ListStyleType<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_counter_style<'a, VisitorT>(visitor: &mut VisitorT, node: &CounterStyle<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_symbols_type<'a, VisitorT>(visitor: &mut VisitorT, node: &SymbolsType)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_symbol<'a, VisitorT>(visitor: &mut VisitorT, node: &Symbol<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_list_style_position<'a, VisitorT>(visitor: &mut VisitorT, node: &ListStylePosition)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_marker_side<'a, VisitorT>(visitor: &mut VisitorT, node: &MarkerSide)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_svg_paint<'a, VisitorT>(visitor: &mut VisitorT, node: &SVGPaint<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        SVGPaint::Url { fallback, url } => {
            if let Some(value_0) = (fallback).as_ref() {
                visitor.visit_svg_paint_fallback((value_0).as_ref());
            }
            visitor.visit_url((url).as_ref());
        }
...
pub fn walk_svg_paint_fallback<'a, VisitorT>(visitor: &mut VisitorT, node: &SVGPaintFallback<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_fill_rule<'a, VisitorT>(visitor: &mut VisitorT, node: &FillRule)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_stroke_linecap<'a, VisitorT>(visitor: &mut VisitorT, node: &StrokeLinecap)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_stroke_linejoin<'a, VisitorT>(visitor: &mut VisitorT, node: &StrokeLinejoin)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_stroke_dasharray<'a, VisitorT>(visitor: &mut VisitorT, node: &StrokeDasharray<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_marker<'a, VisitorT>(visitor: &mut VisitorT, node: &Marker<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_color_interpolation<'a, VisitorT>(visitor: &mut VisitorT, node: &ColorInterpolation)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_color_rendering<'a, VisitorT>(visitor: &mut VisitorT, node: &ColorRendering)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_shape_rendering<'a, VisitorT>(visitor: &mut VisitorT, node: &ShapeRendering)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_text_rendering<'a, VisitorT>(visitor: &mut VisitorT, node: &TextRendering)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_image_rendering<'a, VisitorT>(visitor: &mut VisitorT, node: &ImageRendering)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_clip_path<'a, VisitorT>(visitor: &mut VisitorT, node: &ClipPath<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        ...
        ClipPath::Shape {
            ...
            visitor.visit_basic_shape((shape).as_ref());
        }
...
pub fn walk_geometry_box<'a, VisitorT>(visitor: &mut VisitorT, node: &GeometryBox)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_basic_shape<'a, VisitorT>(visitor: &mut VisitorT, node: &BasicShape<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        BasicShape::Inset(field_0) => {
            visitor.visit_inset_rect((field_0).as_ref());
        }
        BasicShape::Circle(field_0) => {
            visitor.visit_circle_shape((field_0).as_ref());
        }
        BasicShape::Ellipse(field_0) => {
            visitor.visit_ellipse_shape((field_0).as_ref());
        }
        BasicShape::Polygon(field_0) => {
            visitor.visit_polygon((field_0).as_ref());
        }
    }
    visitor.leave_node(AstType::BasicShape);
}
pub fn walk_shape_radius<'a, VisitorT>(visitor: &mut VisitorT, node: &ShapeRadius<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_mask_mode<'a, VisitorT>(visitor: &mut VisitorT, node: &MaskMode)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_mask_clip<'a, VisitorT>(visitor: &mut VisitorT, node: &MaskClip)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_mask_composite<'a, VisitorT>(visitor: &mut VisitorT, node: &MaskComposite)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_mask_type<'a, VisitorT>(visitor: &mut VisitorT, node: &MaskType)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_mask_border_mode<'a, VisitorT>(visitor: &mut VisitorT, node: &MaskBorderMode)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_web_kit_mask_composite<'a, VisitorT>(visitor: &mut VisitorT, node: &WebKitMaskComposite)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_filter_list<'a, VisitorT>(visitor: &mut VisitorT, node: &FilterList<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_filter<'a, VisitorT>(visitor: &mut VisitorT, node: &Filter<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
    ...
    match node {
        ...
        Filter::DropShadow(field_0) => {
            visitor.visit_drop_shadow((field_0).as_ref());
        }
        Filter::Url(field_0) => {
            visitor.visit_url((field_0).as_ref());
        }
...
pub fn walk_z_index<'a, VisitorT>(visitor: &mut VisitorT, node: &ZIndex)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_container_type<'a, VisitorT>(visitor: &mut VisitorT, node: &ContainerType)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_container_name_list<'a, VisitorT>(visitor: &mut VisitorT, node: &ContainerNameList<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_print_color_adjust<'a, VisitorT>(visitor: &mut VisitorT, node: &PrintColorAdjust)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_css_wide_keyword<'a, VisitorT>(visitor: &mut VisitorT, node: &CSSWideKeyword)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_length_percentage<'a, VisitorT>(visitor: &mut VisitorT, node: &LengthPercentage<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_angle_percentage<'a, VisitorT>(visitor: &mut VisitorT, node: &AnglePercentage<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
...
pub fn walk_animation_range_end<'a, VisitorT>(visitor: &mut VisitorT, node: &AnimationRangeEnd<'a>)
where
    VisitorT: ?Sized + Visit<'a>,
{
