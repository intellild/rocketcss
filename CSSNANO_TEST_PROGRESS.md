...
- Passing: 2,759
- Failing: 443
- Explicit skips: 45 (17 parser grammar, 26 lexical/AST boundaries,
  1 selector semantic gap, 1 upstream-disabled case)
- Full-run coverage: offset 0, limit 3,247 (3,202 executed, 45 explicitly skipped)
- Next diagnostic target: border and identifier cross-node IR
- Implementation changes are intentionally uncommitted.
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| all plugins | 0 | 3,247 | 3,202 | 2,759 | 443 | 45 explicit skips; latest complete run |
...
| postcss-colormin | 0 | all | 53 | 51 | 2 | modern alpha colors and safe gradient stops pass; calc remains |
...
| postcss-merge-rules | 0 | all | 160 | 133 | 27 | exact and subset merges use selector-pointer IR |
| postcss-merge-longhand | 187 | 80 | 80 | 80 | 0 | four-side margin/padding groups and variable fallback ordering pass |
| postcss-merge-longhand | 0 | all | 413 | 316 | 97 | basic border groups pass; border shorthand override IR remains |
...
| postcss-convert-values | 0 | all | 97 | 86 | 11 | target-aware zero/unit conversion; calc and typed-zero work remains |

## Remaining failures by plugin

| Plugin | Failing |
| --- | ---: |
| postcss-merge-longhand | 97 |
| cssnano | 57 |
| postcss-merge-rules | 27 |
| pluginCreator | 73 |
| postcss-convert-values | 11 |
| postcss-minify-gradients | 35 |
| postcss-reduce-idents | 36 |
| postcss-colormin | 2 |
| postcss-svgo | 23 |
| postcss-normalize-url | 21 |
| postcss-discard-unused | 21 |
| postcss-merge-idents | 21 |
| cssnano-preset-advanced | 14 |
| cssnano-preset-default | 2 |
| postcss-discard-empty | 0 (3 skipped) |
| postcss-normalize-unicode | 0 (3 skipped) |
| cssnano-preset-lite | 1 |
| pleeease-filters,postcss-svgo | 1 |
...
- Explicitly skipped fifteen inputs that PostCSS accepts but the current
